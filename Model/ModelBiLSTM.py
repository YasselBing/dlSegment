...
class WordSegment(object):
    ...
    def model_lstm(self, dim):
        ...
        lstm1 = Bidirectional(LSTM(512, return_sequences=True))(inputs)
        lstm2 = Bidirectional(LSTM(512, dropout=0.5))(lstm1)
...
if __name__ == '__main__':
    ...
    chinese_word_seg.predict('国家保护承包造林的集体和个人的合法权益，任何单位和个人不得侵犯承包造林的集体和个人依法享有的林木所有权和其他合法权益')
